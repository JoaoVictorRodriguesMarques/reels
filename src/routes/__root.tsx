  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Plataforma SaaS para agendar Reels do Instagram." },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/98b006f9-9a00-4901-9584-49504efb6e26/id-preview-e3535d44--8f05f671-d947-4d26-87cc-74bca09bf695.lovable.app-1779211878909.png",
      },
      {
        name: "twitter:image",
        content:
